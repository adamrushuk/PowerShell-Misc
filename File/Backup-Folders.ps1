...
robocopy "$env:HOMEPATH\code" "$backupDrive\Backups\code\$dateString" /E /Z /ZB /R:5 /W:5 /TBD /NP /MT:16 /njh /ndl /nc /ns /nfl /xd ".git"

Write-Host "Backing up [~/OneDrive] folder..."
robocopy "$env:OneDrive" "$backupDrive\Backups\OneDrive\$dateString" /E /Z /ZB /R:5 /W:5 /TBD /NP /MT:16 /njh /ndl /nc /ns /nfl /xd ".git"

Write-Host "Backing up [~/Google Drive] folder..."
robocopy "$env:HOMEPATH\My Drive" "$backupDrive\Backups\GoogleDrive\$dateString" /E /Z /ZB /R:5 /W:5 /TBD /NP /MT:16 /njh /ndl /nc /ns /nfl /xd ".git"
